...
A better solution would be applying a NLU Engine with more correct tagged intend and entity. ( such as [Snips NLU](https://github.com/snipsco/snips-nlu) or [Rasa NLU](https://github.com/RasaHQ/rasa)) since it is more of a natural language understanding - e.g. chatbot, voiced-base conversation...
